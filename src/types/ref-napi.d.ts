...
export declare const NULL_POINTER: Buffer
...
export declare function readObject(buffer: Buffer, offset?: number): Record<string, any>;
 ...
 */
export declare function writeObject(buffer: Buffer, offset: number, object: Record<string, any>): void;
 ...
 */
export declare function _attach(buffer: Buffer, object: Record<string, any>): void;
...
export declare function _writeObject(buffer: Buffer, offset: number, object: Record<string, any>): void;
